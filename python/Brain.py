...
def n_moving_average(n, symbol, timeframe="day", base="c"):
    """
...
def EMA(symbol, timeframe="1Min", n=12, smoothing=2):
    '''
...
def MACD(symbol, timeframe="1Min", n=-1):
    '''
...
def MFI(symbol, timeframe="1Min", n=14):
    '''
...
def OBV(symbol, timeframe="1Min", n=15):
    '''
...
def RSI(symbol, timeframe="1Min", n=14):
    '''
    ...
    data = Core.get_data(symbol, timeframe, limit=n)
